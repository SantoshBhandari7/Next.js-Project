...
const ProductPage = () => {
  return (
    <main className="min-h-full sm:w-full md:min-h-full lg:w-screen  px-3 py-8">
      <header className="flex flex-col gap-2 py-8 px-6">
        <h1 className="text-xl font-bold pl-4 text-center">Our Products</h1>
        <p className="text-lg text-gray-500 pl-4 text-center">
