    ...
    return (
      <main className="min-h-screen px-6 py-10">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex min-h-100 flex-col items-center justify-center rounded-lg border border-gray-200">
            <IoMdHeart size={60} className="mb-4 text-gray-300" />
            ...
            <Link
              href="/products"
              className="mt-6 rounded-md bg-primary px-6 py-3 font-semibold text-white"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          {wishlists.products.map((product) => (
            ...
            >
              ...
              <div className="p-4">
                {/* Name */}
                <Link href={`/products/${product._id}`}>
                  <h2 className="line-clamp-1 text-lg font-semibold text-primary hover:underline">
                    {product.name}
                  </h2>
                </Link>
                ...
                <Link
                  ...
                  className="block w-full rounded-md bg-primary py-2 text-center font-semibold text-white"
                >
                  View Detail
                </Link>
              </div>
